 ...
 */
library PaymentEip712LibUsingOutputId {
    ...
    bytes32 constant internal EMPTY_INPUT_HASH = keccak256(abi.encode(INPUT_TYPE_HASH, bytes32("")));
    ...
    /** Different from PaymentEip712Lib, this one uses the byte32 of input directly */
